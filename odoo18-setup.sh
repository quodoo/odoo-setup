...
# (e.g. $ODOO_DIR/python3.12/lib/python3.12/site-packages)
#
...
# ------------------------------------------------------------------------------
# Add the custom Python 3.12 binary path to the system PATH
# This allows you to run `python3.12`, `pip3.12`, or any installed CLI tools
# from that directory without needing to type the full path
# (e.g. /efs/odoo/python3.12/bin/python3.12)
# ------------------------------------------------------------------------------
export PATH="$PATH:$ODOO_DIR/python3.12/bin"
...
CUSTOM_ADDONS_PATH="$ODOO_DIR/odoo18/odoo/addons/,$THIRST_PARTY_ADDONS,$CUSTOM_ADDON"
