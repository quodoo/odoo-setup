...
CUSTOM_ADDONS_PATH="$ODOO_DIR/odoo17/addons/,$ODOO_DIR/odoo17/odoo/addons/,$THIRST_PARTY_ADDONS,$CUSTOM_ADDON"
...
sudo tee $ODOO_DIR/nginx/sites-enabled/odoo17.conf > /dev/null <<EOF
